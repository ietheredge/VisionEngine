...
def make_rand_samples(model, image_output_folder, n_latents=4, latent_size=10, n_samples=9, num_steps=300, mu=0, sigma=1):
...
def make_traversal_from_zeros(model, image_output_folder, latent_size=10, n_samples=1, num_steps=11):
...
def make_traversal_from_sample(model, z, image_output_folder, latent_size=10, n_samples=1, num_steps=11, sample_id=0):
    output_folder = os.path.join(image_output_folder, 'explore_latents/traversal')
