    ...
    def make_decoder(self):
        with tf.name_scope('decoder'):
            ...
            with tf.name_scope('f_4'):
                ...
                z_tilde_4 = tf.keras.layers.Dense(16*16*2048, activation=None)(z_tilde_4)
            ...
            with tf.name_scope('f_3'):
                ...
                z_tilde_3 = tf.keras.layers.Dense(32*32*512, activation=None)(z_tilde_3)
            ...
            with tf.name_scope('f_2'):
                ...
                z_tilde_2 = tf.keras.layers.Dense(64*64*128, activation=None)(z_tilde_2)
            ...
            with tf.name_scope('f_1'):
                ...
                z_tilde_1 = tf.keras.layers.Dense(128*128*32, activation=None)(z_tilde_1)
